...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <a class="btn btn-danger btn-block" href="addPrescription.jsp">Make Appointment</a>                                   
                    <a class="btn btn-danger btn-block" href="viewPrescription.jsp">My Appointments</a>                                   
                </div>
            </div>
            <!-- /.row -->
